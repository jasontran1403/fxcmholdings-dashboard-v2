...
const RegisterWithRefLink = React.lazy(() => import('../pages/auth/RegisterWithReflink'))
...
const ProfilePage = React.lazy(() => import('../pages/UpdateProfile'))
...
const Investment = React.lazy(() => import('../pages/Investment/DataTables'))
...
const investmentRoutes: RoutesProps = {
	path: '/admin',
	name: 'Investment',
	icon: 'pages',
	header: 'Navigation',
...
const walletRoutes: RoutesProps = {
	path: '/admin',
	name: 'Wallet',
	icon: 'pages',
	header: 'Navigation',
